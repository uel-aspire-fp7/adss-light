...
public class UELTableLabelProvider extends LabelProvider implements ITableLabelProvider{
	...
	public String getColumnText(Object element, int columnIndex) {
		// TODO Auto-generated method stub
		Object obj = element;
		//System.out.println("in labalprovider, the element is " + element.getClass());
		//if(element instanceof DataforView) 
		//{
		//	obj = ((DataforView) element).getISelectionProvider();
		//}
		//if(element instanceof DataforView[])
		//{
		//	obj = ((DataforView[]) element)[0].getISelectionProvider();
		//}
		//System.out.println("in UELTableLabletProvider, getColumnText(Object element, int columnIndex) started! ");
		if ( ((DataforView) obj).getTransition() != null)
		{
			//System.out.println("in UELTableLabletProvider, obj instanceof Transition ");
