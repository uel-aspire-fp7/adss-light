...
/*
 * this class is the main class to compare two different protection in one specific attack (pn)
 ...
 */
public class CompareToolChains {
	...
	public void createJob(PetriNet ptmodelin, ProtectionSolution pc1in, ProtectionSolution pc2in, ArrayList<Measure> measurelistin, HashMap<String, HashMap<String, String> > mappingin)
	{
