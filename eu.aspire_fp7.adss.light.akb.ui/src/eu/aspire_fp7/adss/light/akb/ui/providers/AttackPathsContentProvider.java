...
/**
 * The attack path content provider.
 * @author Gaofeng Zhang
 **/
public class AttackPathsContentProvider implements ITreeContentProvider
{
	/**
	...
	public Object[] getElements(Object inputElement)
	{
		if (inputElement instanceof Model)
			return ((Model) inputElement).getAttackPaths().toArray();
		else
		{
